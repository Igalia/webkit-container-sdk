...
from the Containerfile and the script build-and-deploy.sh
is executed.
...
Tip: Enable verbose mode when building. Example:
  wkdev-sdk-bakery --trace --verbose --debug --trace --mode build
...
For example, if you have this:
  ...
  --> d7b0866719d
  STEP 27/35: RUN /root/jhbuild-webkit-sdk/build-and-deploy.sh

Then you can debug step 27 with:

  $ podman run -it --rm d7b0866719d /bin/bash
  root@c2ec0d851de0:~# /root/jhbuild-webkit-sdk/build-and-deploy.sh
